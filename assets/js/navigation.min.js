...
/* global carkeekThemeScreenReaderText */
...
function toggleSubMenu(parentMenuItem, forceToggle) {
  ...
  if (parentMenuItemToggled) {
    ...
    toggleButton.setAttribute('aria-label', carkeekThemeScreenReaderText.expand); // Make sure all children are closed.
    ...
    toggleButton.setAttribute('aria-label', carkeekThemeScreenReaderText.collapse);
  }
}
/**
...
function getDropdownButton() {
  ...
  dropdownButton.setAttribute('aria-label', carkeekThemeScreenReaderText.expand);
